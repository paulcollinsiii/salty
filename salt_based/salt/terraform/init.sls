{% set tf = salt['grains.filter_by']({
  'Darwin': {'source': 'https://releases.hashicorp.com/terraform/0.11.8/terraform_0.11.8_darwin_amd64.zip'},
  'Linux': {'source': 'https://releases.hashicorp.com/terraform/0.11.8/terraform_0.11.8_linux_amd64.zip'},
  },
  grain='kernel',
  merge={
    'version': '0.11.8',
    'previous': '0.11.3',
    'hashes': 'https://releases.hashicorp.com/terraform/0.11.8/terraform_0.11.8_SHA256SUMS'
  })
%}
